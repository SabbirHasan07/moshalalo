...
export interface ApiCarouselCarousel extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    add_carousel: Schema.Attribute.Media<'images' | 'files', true> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiCompletedProjectCompletedProject
  ...
  attributes: {
    amount_area: Schema.Attribute.String;
    cover_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    > &
      Schema.Attribute.Private;
    name: Schema.Attribute.String & Schema.Attribute.Required;
    operational_area: Schema.Attribute.Enumeration<
      ['education', 'health', 'poverty Alleviation', 'empowerment']
    > &
      Schema.Attribute.Required;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
...
export interface ApiEventEvent extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    collected_amount: Schema.Attribute.Integer & Schema.Attribute.Required;
    cover_image: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    > &
      Schema.Attribute.Required;
    ...
    donate: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
    ...
    Target_amount: Schema.Attribute.Decimal & Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiIlluminateHumanityIlluminateHumanity
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::illuminate-humanity.illuminate-humanity'
    > &
      Schema.Attribute.Private;
